...
py -m PyInstaller --noconfirm --onefile --windowed --name EQTriage --icon triage.ico --version-file version_info.txt --add-data "version_info.txt;." --distpath dist\EQTriage triage.py || goto :failed
